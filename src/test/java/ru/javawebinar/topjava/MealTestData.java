...
public class MealTestData {
    ...
    public static Meal getNewWrong()  {
        return new Meal(null, of(2020, Month.FEBRUARY, 1, 18, 0), "Созданный ужин", 22300);
    }

    public static Meal getWrongUpdate(){
        return new Meal (MEAL1_ID, meal1.getDateTime().plus(2, ChronoUnit.MINUTES), "Обновленный завтрак", 2);
    }
}
